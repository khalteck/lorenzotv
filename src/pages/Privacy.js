  ...
  return (
    <div className="bg-[#020d18] text-slate-100 pt-8 pb-12 px-4 md:px-[50px]">
      ...
      <p>
        ...
        the following URL: Some of our advertising partners may use cookies and
        web beacons on our site. Our advertising partners includes.
        <br />
        <br />
        ...
        web browsers can be found at the browser's respective websites.
      </p>
      ...
      <p>
        ...
        hyperlinks to your copyrighted material are returned through our search
        ...
        is infringing on your copyrights. We suggest that you first contact an
        attorney for legal assistance on this matter.
        <br />
        <br />
        ...
        <br /> - A statement that the complaining party has a good faith belief
        ...
        allegedly infringed.
        <br /> - Must be signed by the authorized person to act on behalf of the
        ...
        Internet Service Provider will not expedite your request and may result
        in a delayed response due to the complaint not being filed properly.
      </p>
      <ScrollToTop />
    </div>
  );
